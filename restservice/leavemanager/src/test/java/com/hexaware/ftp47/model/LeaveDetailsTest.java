...
public class LeaveDetailsTest {
  ...
  //   final Employee emp = new Employee(100, "SAI", "2018-06-19", 100, 9912140507L, "IT",
  // "KETHU.SAIKUMAR@GMAIL.COM", 30);
  //   LeaveDetails l1 = new LeaveDetails(1, 100, 2, "2019-06-20", "2019-06-21", LeaveType.EL,
  // LeaveStatus.PENDING, "SICK",
  //       "2019-06-20", "APP");
  ...
  public final void testApplyLeave(@Mocked final LeaveDetailsDAO dao) throws ParseException {
    ...
    new Expectations() {
      {
        dao.enterLeaveDetails(1000, startDate, endDate, LeaveType.EL, LeaveStatus.PENDING, "SICK", 2);
      }
    };
    new MockUp<LeaveDetails>() {
      @Mock
    ...
    String apply = LeaveDetails.insertLeaveDetails(1000, start, end, "SICK");
