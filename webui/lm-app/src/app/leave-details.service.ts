...
export class LeaveDetailsService {
  ...
  setApply(empId, startDate, endDate, leaveReason): Observable<String> {
      this.url = "http://localhost:8080/ftp47/api/leave/" + empId + "/apply/";
      return this.http.post(this.url, { "empId": empId, "startDate": startDate, "endDate": endDate, "leaveReason": leaveReason })
